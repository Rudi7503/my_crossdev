...
IDPART1 MACRO   ; IDPART2 is defined in the hw. specific includes
    dc.b 'i2c.library 40.0 (09 Dec 21)'
    ENDM
...
funcTable:
    ...
    STRUCTURE I2CLib,LIB_SIZE
      ...
      ULONG Overflows
      ULONG Errors
      UBYTE HwType						; last element defined in i2c_library.h
      UBYTE myFlags						; private data starts with myFlags
      ULONG SlowI2C
      STRUCT Referee,SS_SIZE        ; a SignalSemaphore
      APTR SysBase
      APTR myConfigDev              ; info about our board
      APTR mySegList
